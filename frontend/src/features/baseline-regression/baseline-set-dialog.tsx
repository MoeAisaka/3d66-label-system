...
export function BaselineSetDialog({
  ...
  return <Dialog.Root open={open} onOpenChange={onOpenChange}>
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[calc(100vh-2rem)] w-[min(1080px,calc(100vw-2rem))] -translate-x-1/2 -translate-y-1/2 flex-col border border-[var(--line-strong)] bg-white shadow-2xl focus:outline-none">
