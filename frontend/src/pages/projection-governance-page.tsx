...
export function ProjectionGovernancePage() {
  ...
  return <>
    <PageHeader index="A.6" title="下游表投影" description="统一维护一个大维表和数个职责明确的小表的版本化合同。本页只连接 LabelLab 本地模拟适配器，不写公司业务数据库。" actions={<Button variant="secondary" onClick={() => contracts.refetch()}><ArrowsClockwise />刷新</Button>} />
