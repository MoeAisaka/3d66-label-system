...
| --- | --- | --- | --- | --- | --- | --- |
| `aliyun_3d66_dw.dim_res_info_union` | SELECT, DESCRIBE | DOWNLOAD, UPDATE, ALTER, DROP, INSERT, DELETE | 运行四项聚合身份探查 | 待 Data Owner 确认，必须限时 | not_requested | 未生成 |
...
| Data Owner | 表与窗口、身份探查、数据质量 | 来源身份签认 | 平台、审核 | 产品、算法 | 表/窗口、probe hash、四项聚合、审批单 | UNASSIGNED |
